...
#define count0addr 0x40020000
#define count1addr 0x40020008
#define count2addr 0x40021000
#define count3addr 0x40021008
...
int main() {
  ...
  for (int i = 0; i < ARR_SIZE(benchmarks); i ++) {
    ...
    if (msg != NULL) {
      ...
      unsigned long memc = ULONG_MAX;
      unsigned long brcc = ULONG_MAX;
      unsigned long insc = ULONG_MAX;
      int succ = 1;
